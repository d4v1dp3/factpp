...
{
    var state = dim.state("AGILENT_CONTROL_50V");
    if (state===undefined)
        return undefined;
    ...
    case "VoltageOff":
        ...
        dim.send("AGILENT_CONTROL_50V/SET_POWER", true);
        return "VoltageOn";
    ...
    throw new Error("AGILENT_CONTROL_50V:"+state.name+"["+state.index+"] unknown or not handled.");
}
