...
priority.
   ...
   - (2) Options from the high priority configuration-file (given by \b -C or \b --config)
   - (3) Database entries
...
//!  whenever the server is neither '127.0.0.1' nor 'localhost'.
//!  Use '/+' to force compression and '/-' to prohibit compression.
//!
//!  @param desc
